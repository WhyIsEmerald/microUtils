    ...
    <div class="container mx-auto px-4 py-8">
        <div class="hero bg-base-100 mb-8">
            <div class="hero-content bg-base-100 text-center">
                <div class="max-w-md">
                    ...
                    <p class="py-6">
                        MicroUtils is a collection of everyday applications
                        built with SvelteKit. It aims to provide useful tools
                        and utilities in a single, easy-to-use package.
                    </p>
                    <a
        ...
        <div class="text-center mt-16">
            ...
            <p class="text-lg text-base-content/80 mb-6">
                MicroUtils is open-source and we welcome contributions of all
                kinds.
            </p>
            <a
